...
| Used to improve the **consistency** & **internal quality**                                    | Focuses on **externally visible** behaviour                                                      |
...
Typical defects that are easier & cheaper to find with static testing compared to dynamic testing:
* Requirement defects
* Design defects
* Coding defects
